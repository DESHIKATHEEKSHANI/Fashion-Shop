...
public class BestInCustomersForm extends JFrame {
    private JTable table;

    public BestInCustomersForm() {
        ...
        String[][] data = getBestCustomersFromFile();
    ...
    private String[][] getBestCustomersFromFile() {
        ...
        Arrays.sort(data, (a, b) -> Double.compare(Double.parseDouble(b[2]), Double.parseDouble(a[2])));
